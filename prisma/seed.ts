import { PrismaClient, Difficulty, Region, Season, ServiceType } from '@prisma/client'
...
async function main() {
  ...
  try {
    ...
    const treks = [
      ...
      {
        name: "Snow Lake Trek",
        description: "Serious/Technical trek to the magnificent Snow Lake in the Karakorams.",
      ...
      },
      {
        ...
        description: "Easy trek to the base of magnificent Rakaposhi peak in Nagar Valley.",
        ...
        distance: 28,
        groupSize: 8,
        highlights: ["Nagar village", "Hapakun campsite", "Minapin glacier", "Rakaposhi basecamp"]
      },
      {
        name: "Rush Lake Trek",
      ...
      },
      {
        ...
        description: "Serious trek to the highest peak in Kaghan Valley with panoramic views of Siran Valley.",
        ...
        distance: 40,
        groupSize: 8,
        highlights: ["Siran valley", "Khori campsite", "Panoramic view of Siran valley"]
      },
      // NEW TREKS FROM DATASET
      {
        name: "Karambar Lake Trek",
        description: "Moderate trek to the stunning Karambar Lake in Chitral region.",
        ...
        distance: 26,
        groupSize: 8,
        highlights: ["Chitral valley", "Boroghil valley", "Karambar lake"]
      },
      {
        name: "Gargoh Meadow",
        description: "Easy trek exploring Gilgit and the beautiful Gargoh Meadow in Bagrote valley.",
        image: "/images/gargoh-meadow-trek.jpg",
        duration: 2,
        difficulty: Difficulty.EASY,
        minCost: 30000,
        maxCost: 40000,
        ...
        distance: 25,
        groupSize: 8,
        highlights: ["Exploring Gilgit", "Gargoh Meadow"]
      },
      {
        name: "Laila Peak Basecamp",
        description: "Serious trek to Laila Peak basecamp through Hushe valley with stunning glacier views.",
        image: "/images/laila-peak-basecamp-trek.jpg",
        duration: 7,
        difficulty: Difficulty.HARD,
        minCost: 150000,
        maxCost: 150000,
        ...
        distance: 40,
        groupSize: 8,
        highlights: ["Khaplu", "Hushe village", "Laila peak", "Mashabrum glacier", "Gondogoro glacier"]
      },
      {
        name: "Munro Trek",
        description: "Moderate trek in Mansehra region offering beautiful mountain views.",
        image: "/images/munro-trek.jpg",
        duration: 3,
        difficulty: Difficulty.MODERATE,
        minCost: 30000,
        maxCost: 30000,
        ...
        distance: 30,
        groupSize: 8,
        highlights: ["Mountain views", "Mansehra region"]
      },
      {
        name: "Thalle Pass",
        description: "Moderate trek through Skardu region crossing the beautiful Thalle Pass.",
        image: "/images/thalle-pass-trek.jpg",
        duration: 4,
        difficulty: Difficulty.MODERATE,
        minCost: 80000,
        maxCost: 100000,
        ...
        distance: 50,
        groupSize: 8,
        highlights: ["Thalle Pass", "Skardu region"]
      },
      {
        name: "K2 Basecamp & GGLA",
        description: "Serious/Technical 2-week expedition to K2 basecamp and Gondogoro La in the Karakorams.",
        image: "/images/k2-basecamp-ggla-trek.png",
        duration: 14,
        difficulty: Difficulty.EXTREME,
        minCost: 350000,
        maxCost: 350000,
        ...
        distance: 180,
        groupSize: 8,
        highlights: ["K2 Basecamp", "Gondogoro La", "Karakoram Range"]
      },
      {
        name: "Barah Broq & Moses Peak",
        description: "Moderate trek in Khaplu region to Barah Broq and Moses Peak.",
        image: "/images/barah-broq-moses-peak-trek.png",
        duration: 5,
        difficulty: Difficulty.MODERATE,
        minCost: 100000,
        maxCost: 150000,
        ...
        distance: 50,
        groupSize: 8,
        highlights: ["Barah Broq", "Moses Peak", "Khaplu region"]
      }
    ]
